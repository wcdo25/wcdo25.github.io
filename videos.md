...
![image](https://krorgs.github.io/gifs/.gif) <br>
asdf.<br>
[youtube](asdf) |
[download](asdf)
<br><br>
8: c21 9 3384 fast
caption: AI-designed H shapes are even better: they reproduce more often than toruses or the default spheres.
...
<br><br>
12: c24 9 1070 fast
caption: The best design was a C shape (Macaroni).
...
[download](asdf)
<br><br>
13: c5 9 6897 trimmed fast
caption: Variations on the C shape proposed by AI included a design with a long narrow mouth (PacMan). 
...
[download](asdf)
<br><br>
17: c26 9 16233 trimmed fast
caption: Another C-shape variant proposed by AI resembled a half donut.
...
[download](asdf)
<br><br>
19: buildingLargerOffspring fast
caption: Progressively larger offspring. In contrast to other known forms of biological reproduction, kinematic self replication allows for the opportunity to significantly enlarge and miniaturize offspring, each generation. 
...
<br><br>
20: a5 25 fast
caption: Exponential growth. If the simulated progenitors are left in the dish, they can assist in building future generations of offspring. 
...
[download](asdf)
<br><br>
21: roundingPile fast
caption: Predicted piling behavior of the AI-designed parent swarms matches the living systems.
...
[download](asdf)
<br><br>
22: roundingAnotherPile fast
caption: Another example of piling behavior predicted of the C-shape.
...
[download](asdf)
<br><br>
24: circuit15 side view cropped fast
...
<br><br>
25: tree
caption: Exponential utility. Each branch represents replication; red branches denote circuit completion.
...
[download](asdf)
<br><br>
26: t6 9 1101 trimmed fast
caption: Evolved terrain with a hook. The algorithm was modified to evolve terrain shape rather than progenitor shape to amplify self replication. Terrain was shaped by the inclusion of reconfigurable walls (black) that, once positioned along the bottom surface of the simulated dish, constrain the stochastic movement of organisms along more predictable trajectories within predefined limits. 
...
[download](asdf)
<br><br>
28: t3 9 1268 trimmed fast
caption:  Evolved terrain with a slide.
...
[download](asdf)
<br><br>
30: o99 9 33 trimmed fast fail
caption: In a cluttered environment (black “boulders”), the wild type progenitors (spheroids) cannot move enough to self replicate. 
